...
let hourlyData = {
   ...
   datasets: [{
     data: [11, 13, 4, 20, 15, 30, 58, 77, 112, 150, 185, 140, 443, 566, 420, 390, 222, 200, 150, 175, 125, 35, 50, 22],
   }]
}
...
let dailyData1 = {
  ...
  datasets: [{
    data: [2250, 1200, 1500, 2400, 1700, 3000, 2450],
  }]
}
...
let weeklyData = {
  ...
  datasets: [{
    data: [9000, 10300, 8800, 11000, 14000, 16000, 9500, 12500, 10300, 15550, 13450],
  }]
}
...
let monthlyData = {
  ...
  datasets: [{
    data: [112000, 134000, 140000, 230000, 210000, 195000, 189000, 225000, 320000, 298000, 246000, 199000],
  }]
}
